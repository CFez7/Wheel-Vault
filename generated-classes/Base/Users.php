...
abstract class Users implements ActiveRecordInterface
{
    ...
    /**
     * The value for the upassword field.
     *
     * @var        string
     */
    protected $upassword;
    ...
    /**
     * Get the [upassword] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [upassword] column.
     *
     * @param string $v new value
     * @return $this|\Users The current object (for fluent API support)
     */
    public function setUpassword($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->upassword !== $v) {
            $this->upassword = $v;
            $this->modifiedColumns[UsersTableMap::COL_UPASSWORD] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsersTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsersTableMap::translateFieldName('Location', TableMap::TYPE_PHPNAME, $indexType)];
            $this->location = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UsersTableMap::translateFieldName('Upassword', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upassword = (null !== $col) ? (string) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_UPASSWORD)) {
            $modifiedColumns[':p' . $index++]  = 'upassword';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'location':
                        ...
                        break;
                    case 'upassword':
                        $stmt->bindValue($identifier, $this->upassword, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_UPASSWORD)) {
            $criteria->add(UsersTableMap::COL_UPASSWORD, $this->upassword);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setUpassword($this->getUpassword());
        if ($makeNew) {
            $copyObj->setNew(true);
