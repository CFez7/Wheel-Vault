 ...
 * @method     ChildUsersQuery orderByUpassword($order = Criteria::ASC) Order by the upassword column
 *
 ...
 * @method     ChildUsersQuery groupByUpassword() Group by the upassword column
 *
 ...
 * @method     ChildUsers findOneByUpassword(string $upassword) Return the first ChildUsers filtered by the upassword column *
 ...
 * @method     ChildUsers requireOneByUpassword(string $upassword) Return the first ChildUsers filtered by the upassword column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUsers[]|ObjectCollection findByUpassword(string $upassword) Return ChildUsers objects filtered by the upassword column
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    {
        throw new LogicException('The Users object has no primary key');
    }
    ...
    /**
     * Filter the query on the upassword column
     *
     * Example usage:
     * <code>
     * $query->filterByUpassword('fooValue');   // WHERE upassword = 'fooValue'
     * $query->filterByUpassword('%fooValue%'); // WHERE upassword LIKE '%fooValue%'
     * </code>
     *
     * @param     string $upassword The value to use as filter.
     *              Accepts wildcards (* and % trigger a LIKE)
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildUsersQuery The current query, for fluid interface
     */
    public function filterByUpassword($upassword = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($upassword)) {
                $comparison = Criteria::IN;
            } elseif (preg_match('/[\%\*]/', $upassword)) {
                $upassword = str_replace('*', '%', $upassword);
                $comparison = Criteria::LIKE;
            }
        }

        return $this->addUsingAlias(UsersTableMap::COL_UPASSWORD, $upassword, $comparison);
    }
    ...
    {
        if ($users) {
            throw new LogicException('Users object has no primary key');
