...
class UsersTableMap extends TableMap
{
    ...
    /**
     * the column name for the upassword field
     */
    const COL_UPASSWORD = 'users.upassword';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Email', 'Phone', 'Location', 'Upassword', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'email', 'phone', 'location', 'upassword', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_NAME, UsersTableMap::COL_EMAIL, UsersTableMap::COL_PHONE, UsersTableMap::COL_LOCATION, UsersTableMap::COL_UPASSWORD, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'email', 'phone', 'location', 'upassword', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Email' => 2, 'Phone' => 3, 'Location' => 4, 'Upassword' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'phone' => 3, 'location' => 4, 'upassword' => 5, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_NAME => 1, UsersTableMap::COL_EMAIL => 2, UsersTableMap::COL_PHONE => 3, UsersTableMap::COL_LOCATION => 4, UsersTableMap::COL_UPASSWORD => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'phone' => 3, 'location' => 4, 'upassword' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('phone', 'Phone', 'VARCHAR', true, 13, null);
        $this->addColumn('location', 'Location', 'VARCHAR', true, 25, null);
        $this->addColumn('upassword', 'Upassword', 'VARCHAR', true, 61, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_UPASSWORD);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.upassword');
        }
    }
